        ...
        <c:if test="${!empty sessionScope.UID}">
            ...
            <c:forEach var="mb" items="${mbvo}">
                ...
                <div class="mb_product_list">
                    ...
                    <input type="hidden" id="discount_mb${mbnum}" name="discount" value="${mb.mydiscount * mb.myamount}" disabled> <%--개별상품 총 할인액 수정필요--%>
                    <input type="hidden" id="dcPrice_mb${mbnum}" name="dcPrice" value="${mb.myprice * mb.myamount}" disabled><%--개별상품 총 할인된가격 수정필요--%>
                    <input type="hidden" id="ogPrice_mb${mbnum}" name="ogPrice" value="${mb.myogprice * mb.myamount}" disabled><%--개별상품 총 할인안된가격 수정필요--%>
