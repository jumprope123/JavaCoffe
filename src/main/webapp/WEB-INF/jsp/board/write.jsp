        ...
        <div class="card card-body bg-light margin1050">
            ...
            <div class="form-group row">
                ...
                <div class="custom-file col-9">
                    ...
                    <label class="custom-file-label" id="file1bLable">첨부할 파일을 선택하세요</label>
                </div>
                <div class="custom-file col-9 offset-2">
                    <input type="file" id="file2b" name="file" class="custom-file-input">
                    <label class="custom-file-label" id="file2bLable">첨부할 파일을 선택하세요</label>
                </div>
                <div class="custom-file col-9 offset-2">
                    <input type="file" id="file3b" name="file" class="custom-file-input">
                    <label class="custom-file-label" id="file3bLable">첨부할 파일을 선택하세요</label>
                </div>
            </div><!--파일첨부 끝-->
            <div class="form-group row">
